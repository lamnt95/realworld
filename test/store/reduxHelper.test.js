...
const ReduxHelper = require("../../redux-store/reduxHelper");

describe("Test authApi ", () => {
  it("should right type", () => {
    const types = ReduxHelper.type("AUTH")({
      INIT_AUTH_START: "E",
      INIT_AUTH_SUCCESS: "E",
      INIT_AUTH_FAIL: "E",
      ADD_ACCESS_TOKEN: "R"
    });
    const actions = ReduxHelper.action(types);
    ...
    expect(actions.initAuthStart("payload", "meta", "error")).toEqual({
